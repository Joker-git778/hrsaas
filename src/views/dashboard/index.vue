<template>
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ userInfo.name }}，祝你开心每一天！</p>
    ...
    <el-dialog title="添加" :visible.sync="showDialog">
      <el-form ref="ruleForm" :model="ruleForm" rules="rules" label-width="100px" :inline="false" size="normal">
        ...
        <el-form-item label="期望离职时间" prop="reason">
          <el-input
